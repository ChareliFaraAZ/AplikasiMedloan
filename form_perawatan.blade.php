...
<body>
  <div class="container">
    <header>
      <img src="{{ asset('assets/logo website baru.png') }}" alt="MedLoan Logo" class="logo" />
      <h1>FORM LAPORAN PERAWATAN ALAT</h1>
    </header>

    <form class="form-card" method="POST" action="{{ route('perawatan.store') }}" enctype="multipart/form-data">
      @csrf
      <div class="form-left">
        <label>
          <div style="display:flex; align-items:center;">
            <img src="{{ asset('assets/teknisi.png') }}" alt="" /> NAMA TEKNISI:
          </div>
        ...
        <label>
          <div style="display:flex; align-items:center;">
            <img src="{{ asset('assets/unit kerja.png') }}" alt="" /> UNIT KERJA:
          </div>
        ...
        <label>
          <div style="display:flex; align-items:center;">
            <img src="{{ asset('assets/tanggal.png') }}" alt="" /> TANGGAL DAN WAKTU PERBAIKAN:
          </div>
          <div class="split">
        ...
        <label>
          <div style="display:flex; align-items:center;">
            <img src="{{ asset('assets/jenis perawatan.png') }}" alt="" /> JENIS PERAWATAN:
          </div>
        ...
        <label>
          <div style="display:flex; align-items:center;">
            <img src="{{ asset('assets/tindakan.png') }}" alt="" /> DESKRIPSI TINDAKAN:
          </div>
      ...
      <div class="form-right">
        <label>
          <div style="display:flex; align-items:center;">
            <img src="{{ asset('assets/up gambar.png') }}" alt="" /> UNGGAH GAMBAR:
          </div>
        ...
        <label>
          <div style="display:flex; align-items:center;">
    <img src="{{ asset('assets/nama alat.png') }}" alt="" /> NAMA ALAT:
  </div>
  <input type="text" name="nama_alat" value="{{ $nama_alat ?? '' }}" placeholder="masukkan nama alat...." required />
        </label>

        <label>
          <div style="display:flex; align-items:center;">
            <img src="{{ asset('assets/kondisi.png') }}" alt="" /> KONDISI SETELAH PERAWATAN:
          </div>
