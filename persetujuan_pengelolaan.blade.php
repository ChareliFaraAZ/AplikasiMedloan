  ...
  <div class="container">
    <aside class="sidebar">
      ...
      <ul class="nav">
        ...
        <li><a href="{{ url('/pengelolaan_daftar_alat_medis') }}">PENGELOLAAN DAFTAR ALAT MEDIS</a></li>
        <li class="active"><a href="{{ url('/persetujuan_pengelolaan') }}">PERSETUJUAN & PENGELOLAAN</a></li>
