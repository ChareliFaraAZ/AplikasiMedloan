    ...
    <form action="{{ route('laporan-kerusakan.store') }}" method="POST">
      ...
      <div class="report-box">
        ...
        <div class="detail-section">
          <div class="info-box">
            <img src="{{ asset('assets/Vector.png') }}" alt="Icon Nama" />
          ...
          <div class="info-box">
            <img src="{{ asset('assets/streamline-freehand_desk-computer-base-work-standing-user-1.png') }}" alt="Icon Jabatan" />
          ...
          <div class="info-box">
            <img src="{{ asset('assets/clarity_tools-solid.png') }}" alt="Icon Alat Medis" />
          ...
          <div class="info-box">
            <img src="{{ asset('assets/carbon_report.png') }}" alt="Icon Laporan" />
