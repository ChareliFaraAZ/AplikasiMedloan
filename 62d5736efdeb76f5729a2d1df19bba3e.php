...
<body>
  <div class="container">
    ...
    <aside class="sidebar">
      ...
      <nav>
        ...
        <li><a href="<?php echo e(route('form.lapor.kerusakan')); ?>">LAPORAN KERUSAKAN</a></li>
    ...
    <main class="main-content">
      ...
      <form method="GET" action="<?php echo e(url()->current()); ?>" style="margin-bottom: 20px;">
  <input type="text" name="search" placeholder="Cari nama alat..." value="<?php echo e(request('search')); ?>"
  ...
  <button type="submit"
    ...
    Cari
      ...
      <div class="alat-grid">
        ...
        <div class="alat-card">
          <img src="<?php echo e(asset('assets/' . $item->gambar)); ?>" alt="<?php echo e($item->nama); ?>">
          <div class="nama-alat"><?php echo e(strtoupper($item->nama)); ?></div>
          <button class="btn-pinjam" onclick="window.location.href='<?php echo e(url('form_peminjaman?alat_id=' . $item->id)); ?>'">PINJAM</button>
  ...
  <div style="grid-column: 1 / -1; text-align: center; color: #555; font-style: italic; font-size: 1.1em;">
    Tidak ada alat ditemukan<?php echo e(request('search') ? ' untuk pencarian "' . request('search') . '"' : ''); ?>.
  </div>
<?php endif; ?>
...
<?php /**PATH D:\laragon\www\aplikasi-medloan\resources\views/peminjaman.blade.php ENDPATH**/ ?>