...
<body>
  <div class="main-bg">
    ...
    <form class="form-card" autocomplete="off" method="POST" action="<?php echo e(url('/prosespeminjaman')); ?>">
      <?php echo csrf_field(); ?>
      <input type="hidden" name="alat_id" value="<?php echo e($alat->id); ?>">
      
      <!-- Kiri: Info alat -->
      <div class="alat-info">
        <img src="<?php echo e(asset('assets/' . $alat->gambar)); ?>" alt="<?php echo e($alat->nama); ?>">
        <div class="nama-alat"><?php echo e(strtoupper($alat->nama)); ?></div>
        <div class="status">STATUS : <?php echo e($alat->status); ?></div>
        <div class="stok">STOK : <?php echo e($alat->stok); ?></div>
      </div>
  ...
  <div class="input-group">
    ...
    <input type="number" name="jumlah" min="1" max="<?php echo e($alat->stok); ?>" required placeholder="JUMLAH">
  </div>
</div>
...
<?php /**PATH D:\laragon\www\aplikasi-medloan\resources\views/form_peminjaman.blade.php ENDPATH**/ ?>