  ...
  <div class="container">
    <aside class="sidebar">
      ...
      <ul class="nav">
        ...
        <li><a href="{{ url('/laporan-pemakaian') }}">LAPORAN PEMAKAIAN ALAT</a></li>
        <li class="active"><a href="{{ url('/pengelolaan_daftar_alat_medis') }}">PENGELOLAAN DAFTAR ALAT MEDIS</a></li>
        <li><a href="{{ url('/persetujuan_pengelolaan') }}">PERSETUJUAN DAN PENGELOLAAN</a></li>
